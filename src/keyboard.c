...
byte ktoa(int c){
	 ...
	 * El scancode que se recibe al presionar una tecla sirve de 铆ndice para cada fila. */
...
/* 
 * Funci贸n que devuelve el siguiente caracter del buffer de teclado.
...
/*
 * Funci贸n que escribe en el buffer de teclado el byte c.
 */
void 
