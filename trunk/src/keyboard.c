...
unsigned char ktoa(int c){
    int const normal[]={0x1B,0x31,0x32,0x33,0x34,0x35,0x36,0x37,0x38,0x39
      ,0x30,0x2D,0x3D,0x08,0x09,0x71,0x77,0x65,0x72
      ,0x74,0x79,0x75,0x69,0x6F,0x70,0x5B,0x5D,0x0D
      ...
      int const up[]={0x1B,0x31,0x32,0x33,0x34,0x35,0x36,0x37,0x38,0x39
      ,0x30,0x2D,0x3D,0x08,0x09,0x71,0x77,0x65,0x72
      ,0x74,0x79,0x75,0x69,0x6F,0x70,0x5B,0x5D,0x0D
      ,0x00/*ctrl*/,0x61,0x73,0x64,0x66,0x67,0x68,0x6A
      ,0x6B,0x6C,0x3B,0x27,0x60,0x00/*Lshifht*/,0x5C
    ...
    int const shiftted[]={0x1B,0x21,0x40,0x23,0x24,0x25,0x5E,0x26,0x2A,0x28
    ...
    if(c<0x81)
      ...
      return (unsigned char)shiftted[c-1-0x80];
    else
      return (unsigned char)up[c-1-0x80];
